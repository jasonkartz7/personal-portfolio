...
export default function ExperienceCard({}: Props) {
  return (
    <article
      className="flex flex-col rounded-lg items-center space-y-5 flex-shrink-0 w-[500px] md:w-[500px] xl:w-[900px] xl:h-[450px] 
      ...
      <div className="px-0 md:px-10">
        ...
        <ul className="list-disc space-y-2 ml-5 text-lg">
          <li>
            ...
            Points Summary PointsSummary PointsSummary PointsSummary

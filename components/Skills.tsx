...
function Skills({}: Props) {
  return (
    ...
    >
      <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl mx-5">
        Skills
      </h3>

      <div
        className="grid grid-cols-4 gap-5 flex-col rounded-lg items-center space-y-6 flex-shrink-0
